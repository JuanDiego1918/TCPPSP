...
public class Tabbed extends AppCompatActivity implements AllFrgaments{
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                ...
                case 1:
                    DefectsInjectedInPhase injectedInPhase = new DefectsInjectedInPhase();
                    return injectedInPhase;

                case 2:
                    DefectsRemoveInPhase removeInPhase = new DefectsRemoveInPhase();
                    return removeInPhase;
            }
